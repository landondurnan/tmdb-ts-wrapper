...
exports.Authenticationv3 = void 0;
const Endpoint_1 = __importDefault(require("./Endpoint"));
class Authenticationv3 extends Endpoint_1.default {
    /**
     ...
     */
    createGuestSession() {
        return this._get(`authentication/guest_session/new`);
    }
    /**
     ...
     */
    createRequestToken() {
        return this._get(`authentication/token/new`);
    }
    /**
     * Create Session
     *
    ...
    createSession(request_token) {
        return this._post("authentication/session/new", { request_token });
    }
    /**
    ...
    */
    createSessionWithLogin(requestBody) {
        return this._post("authentication/token/validate_with_login", requestBody);
    }
    /**
    ...
    */
    createSessionWithToken() {
        return this._post("authentication/session/convert/4", { access_token: this.config.access_token });
    }
    /**
     * Delete Session
     *
    ...
    */
    deleteSession(session_id) {
        return this._delete("authentication/session", { session_id });
    }
}
exports.Authenticationv3 = Authenticationv3;
//# sourceMappingURL=Authenticationv3.js.map