...
export declare class Authenticationv4 extends Endpoint {
    /**
     ...
     */
    createRequestToken(redirect_to?: string): Promise<Authenticationv4CreateRequestTokenResponse>;
    /**
     * Create Access Token
     *
     ...
     */
    createAccessToken(request_token: string): Promise<Authenticationv4CreateAccessTokenResponse>;
    /**
     * Delete Access Token
     *
    ...
    */
    deleteAccessToken(access_token: string): Promise<Authenticationv4DeleteAccessTokenResponse>;
}
